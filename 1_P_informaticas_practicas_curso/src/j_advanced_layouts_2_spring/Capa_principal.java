...
public class Capa_principal extends JPanel{
	...
	public Capa_principal() {
		...
		layout.putConstraint(SpringLayout.WEST, btn_2, spring, SpringLayout.EAST, btn_1);
		layout.putConstraint(SpringLayout.WEST, btn_3, spring, SpringLayout.EAST, btn_2);
